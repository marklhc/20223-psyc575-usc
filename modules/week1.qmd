...
Another example that relates to ecological fallacies is the ["happiness paradox"](https://www.pnas.org/doi/10.1073/pnas.1015962107) in economics, which says that income is related to happiness in a cross-sectional analysis (i.e., between-person level) but not in a longitudinal/time series analysis (i.e., within-person level).
...
If you need a refresher on multiple regression, please check out [this module](week1b.qmd).

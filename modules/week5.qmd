...
From the results below, what is the test statistic and the $p$ value for the fixed effect coefficient for `meanses`?
...
#| results: asis
practice_question(
    "Which distribution is used to make conclusion for Bayesian parameter estimation?",
